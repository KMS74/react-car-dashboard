...
import carImage1 from "../assets/images/car-audi-a3-audi-a4-car-3822c2bc08e2c2bce1d8ead0e70c7ddb.png";
import carImage2 from "../assets/images/2014-mercedes-benz-m-class-2012-mercedes-benz-m-class-2008-mercedes-benz-m-class-sport-utility-vehicle-mercedes-car-png-image-8230b0372dd015bcf5312eb17e2751ee.png";
import carImage3 from "../assets/images/white car.png";
import carImage4 from "../assets/images/maruti-suzuki-dzire-car-suzuki-ertiga-swift-dzire-f8a7d4ae19bd1c349dc080d9081ffd31.png";
import carImage5 from "../assets/images/suzuki-ertiga-maruti-car-suzuki-ciaz-suzuki-dcac04d3f676c91c7ca6f2d195b86ff3.png";
import carImage6 from "../assets/images/toyota-innova-toyota-avanza-car-rush-toyota-seven-cars-a3650fca54041ac1aaae4fe013ac79ca 1.png";

const BookingView = () => {
  return (
    <main className="main-container">
      <h1 className="primary-header">Booking</h1>
      <div className="cars-filter">
        ...
        <div className="layout-controlers">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
      ...
      <section className="booked-cars">
        <BookingCarCard carImage={carImage1} />
        <BookingCarCard carImage={carImage2} />
        <BookingCarCard carImage={carImage3} />
        <BookingCarCard carImage={carImage4} />
        <BookingCarCard carImage={carImage5} />
        <BookingCarCard carImage={carImage6} />
      </section>
    </main>
  );
};
